...
./openstack-helm/tools/deployment/developer/common/020-setup-client.sh
./openstack-helm/tools/deployment/developer/common/030-ingress.sh
./openstack-helm/tools/deployment/developer/ceph/040-ceph.sh
./openstack-helm/tools/deployment/developer/ceph/045-ceph-ns-activate.sh
./openstack-helm/tools/deployment/developer/ceph/050-mariadb.sh
./openstack-helm/tools/deployment/developer/ceph/060-rabbitmq.sh
./openstack-helm/tools/deployment/developer/ceph/070-memcached.sh
./openstack-helm/tools/deployment/developer/ceph/080-keystone.sh
./openstack-helm/tools/deployment/developer/ceph/090-heat.sh
./openstack-helm/tools/deployment/developer/ceph/100-horizon.sh
./openstack-helm/tools/deployment/developer/ceph/110-ceph-radosgateway.sh
./openstack-helm/tools/deployment/developer/ceph/120-glance.sh
./openstack-helm/tools/deployment/developer/ceph/130-cinder.sh
./openstack-helm/tools/deployment/developer/ceph/140-openvswitch.sh
./openstack-helm/tools/deployment/developer/ceph/150-libvirt.sh
./openstack-helm/tools/deployment/developer/ceph/160-compute-kit.sh
./openstack-helm/tools/deployment/developer/ceph/170-setup-gateway.sh
./openstack-helm/tools/deployment/developer/common/900-use-it.sh
